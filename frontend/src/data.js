export const reportData = [
  ...
  { 
    ...
    partners: [
      { 
        name: '삼성SDS', deals: 12, color: '#004EA1',
        contacts: [
      ...
      { 
        name: 'LG CNS', deals: 8, color: '#006FFF',
        contacts: [
      ...
      { 
        name: '다우기술', deals: 4, color: '#009DFF',
        contacts: [
  ...
  { 
    ...
    partners: [
      { 
        name: 'KT Cloud', deals: 12, color: '#004EA1',
        contacts: [
      ...
      { 
        name: 'SK C&C', deals: 8, color: '#006FFF',
        contacts: [
      ...
      { 
        name: '메가존클라우드', deals: 4, color: '#009DFF',
        contacts: [
